...
figure(2)
subplot(1,2,1)
plot(V,Ry_max,'-ro',MarkerSize=8,MarkerFaceColor='r',LineWidth=1.5)
hold on
errorbar(V_exp,Ry_exp,Ry_Err_exp,'--sk',MarkerFaceColor='k',MarkerSize=8,LineWidth=1.5)
hold on
plot(V_exp,Ry_Dunn,'-.d','Color',[0 0.5 0.0],MarkerFaceColor=[0 0.5 0.0],MarkerSize=8,LineWidth=1.5)
grid on
set(gca,Fontsize=14)
...
subplot(1,2,2)
plot(V,Theta_max,'-ro',MarkerSize=8,MarkerFaceColor='r',LineWidth=1.5)
hold on
errorbar(V_exp,Theta_exp,Theta_Err_exp,'--sk',MarkerFaceColor='k',MarkerSize=8,LineWidth=1.5)
hold on
plot(V_exp,Theta_Dunn,'-.d','Color',[0 0.5 0.0],MarkerFaceColor=[0 0.5 0.0],MarkerSize=8,LineWidth=1.5)
...
% hold on
plot(Laminate_0_90.V25_5.Theta(4000:end) -0.5*(min(Laminate_0_90.V25_5.Theta(4000:end))+max(Laminate_0_90.V25_5.Theta(4000:end))),-Laminate_0_90.V25_5.Ry(4000:end)+ 0.5*(min(Laminate_0_90.V25_5.Ry(4000:end))+max(Laminate_0_90.V25_5.Ry(4000:end))),'r',LineWidth=1.5)
hold on
plot(Laminate_0_90.V26.Theta(4000:end) -0.5*(min(Laminate_0_90.V26.Theta(4000:end))+max(Laminate_0_90.V26.Theta(4000:end))),-Laminate_0_90.V26.Ry(4000:end)+ 0.5*(min(Laminate_0_90.V26.Ry(4000:end))+max(Laminate_0_90.V26.Ry(4000:end))),'b',LineWidth=1.5)
hold on
plot(Laminate_0_90.V26_5.Theta(2000:end) -0.5*(min(Laminate_0_90.V26_5.Theta(2000:end))+max(Laminate_0_90.V26_5.Theta(2000:end))),-Laminate_0_90.V26_5.Ry(2000:end)+0.5*(min(Laminate_0_90.V26_5.Ry(2000:end))+max(Laminate_0_90.V26_5.Ry(2000:end))),'Color',[0 0.5 0.0],LineWidth=1.5)
hold on
plot(Laminate_0_90.V27.Theta(2000:end) -0.5*(min(Laminate_0_90.V27.Theta(2000:end))+max(Laminate_0_90.V27.Theta(2000:end))),-Laminate_0_90.V27.Ry(2000:end)+ 0.5*(min(Laminate_0_90.V27.Ry(2000:end))+max(Laminate_0_90.V27.Ry(2000:end))),'k',LineWidth=1.5)
hold on
...
hold on
fill([0.1 0.1 2.0 2.0],[-5 5 5 -5],'k',FaceAlpha=0.3)
hold on
fill([2.0 2.0 3.0 3.0],[-5 5 5 -5],'r',FaceAlpha=0.3)
...
figure(5)
subplot(1,2,1)
plot(V,Ry_max,'-ro',MarkerFaceColor='r',LineWidth=1.5,MarkerSize=8)
hold on
errorbar(V_exp,Ry_exp,Ry_Err_exp,'--sk',MarkerFaceColor='k',LineWidth=1.5,MarkerSize=8)
grid on
set(gca,"FontSize",14)
% xlim([25 30])
% ylim([0 30])
...
ylabel('\Delta R_y in m')
subplot(1,2,2)
plot(V,Theta_max,'-ro',MarkerFaceColor='r',LineWidth=1.5,MarkerSize=8)
hold on
errorbar(V_exp,Theta_exp,Theta_Err_exp,'--sk',MarkerFaceColor='k',LineWidth=1.5,MarkerSize=8)
legend('ASWING','Exp')
...
plot(Laminate_p15_0.V28_5.Theta(4000:end) -0.5*(min(Laminate_p15_0.V28_5.Theta(4000:end))+max(Laminate_p15_0.V28_5.Theta(4000:end))),-Laminate_p15_0.V28_5.Ry(4000:end)+ 0.5*(min(Laminate_p15_0.V28_5.Ry(4000:end))+max(Laminate_p15_0.V28_5.Ry(4000:end))),'r',LineWidth=1.5)
hold on
plot(Laminate_p15_0.V29.Theta(4000:end) -0.5*(min(Laminate_p15_0.V29.Theta(4000:end))+max(Laminate_p15_0.V29.Theta(4000:end))),-Laminate_p15_0.V29.Ry(4000:end)+ 0.5*(min(Laminate_p15_0.V29.Ry(4000:end))+max(Laminate_p15_0.V29.Ry(4000:end))),'b',LineWidth=1.5)
hold on
plot(Laminate_p15_0.V29_5.Theta(4000:end) -0.5*(min(Laminate_p15_0.V29_5.Theta(4000:end))+max(Laminate_p15_0.V29_5.Theta(4000:end))),-Laminate_p15_0.V29_5.Ry(4000:end)+ 0.5*(min(Laminate_p15_0.V29_5.Ry(4000:end))+max(Laminate_p15_0.V29_5.Ry(4000:end))),'Color',[0 0.5 0.0],LineWidth=1.5)
hold on
plot(Laminate_p15_0.V30.Theta(2000:end) -0.5*(min(Laminate_p15_0.V30.Theta(2000:end))+max(Laminate_p15_0.V30.Theta(2000:end))),-Laminate_p15_0.V30.Ry(2000:end)+0.5*(min(Laminate_p15_0.V30.Ry(2000:end))+max(Laminate_p15_0.V30.Ry(2000:end))),'k',LineWidth=1.5)
hold on
grid on
xlabel('\Delta \theta in °')
ylabel('\Delta R_y in m')
...
figure(4)
subplot(1,3,1)
plot(Mode1(:,1),Mode1(:,2),'-rs',MarkerFaceColor='r',MarkerSize=8)
hold on
plot(Mode2(:,1),Mode2(:,2),'-bs',MarkerFaceColor='b',MarkerSize=8)
hold on
plot(Mode3(:,1),Mode3(:,2),'-kv',MarkerFaceColor='k',MarkerSize=8)
hold on
fill([0 40 40 0],[-10 -10 300 300],'r','FaceAlpha',0.3)
...
subplot(1,3,2)
plot(V,mode1_damp,'-ro',MarkerFaceColor='r',MarkerSize=8)
hold on
plot(V,mode2_damp,'-bs',MarkerFaceColor='b',MarkerSize=8)
hold on
plot(V,mode3_damp,'-kv',MarkerFaceColor='k',MarkerSize=8)
plot([0 30],[0.0 0.0],'--r','LineWidth',2.0)
hold on
fill([0 40 40 0],[0 0 -2 -2],'r','FaceAlpha',0.3)
...
subplot(1,3,3)
plot(V,mode1_freq,'-ro',MarkerFaceColor='r',MarkerSize=8)
hold on
plot(V,mode2_freq,'-bs',MarkerFaceColor='b',MarkerSize=8)
hold on
plot(V,mode3_freq,'-kv',MarkerFaceColor='k',MarkerSize=8)
...
set(gca,fontsize=14)
hold on
fill([0 200 300 0],[-10 -10 500 500],'r','FaceAlpha',0.3)
% legend('1rst bending mode','1rst Torsion mode','2nd Bending mode')
sgrid
ylim([0.1 400])
xlim([-200 200])
...
hold on
fill([0 120 120 0],[0 0 -2 -2],'r','FaceAlpha',0.3)
set(gca,fontsize=14)
...
legend('1rst bending','1rst Torsion','2nd bending','2nd torsion')
% xlim([6 30])
% legend('1rst bending mode','1rst Torsion mode','2nd Bending mode')
grid on 
xlabel('V in m/s')
...
figure(6)
subplot(1,3,1)
plot(Mode1(:,1),Mode1(:,2),'-ro',MarkerFaceColor='r',LineWidth=1.0,MarkerSize=8)
hold on
plot(Mode2(:,1),Mode2(:,2),'-bs',MarkerFaceColor='b',LineWidth=1.0,MarkerSize=8)
hold on
plot(Mode3(:,1),Mode3(:,2),'-kd',MarkerFaceColor='k',LineWidth=1.0,MarkerSize=8)
hold on
fill([0 40 40 0],[-10 -10 300 300],'r','FaceAlpha',0.3)
set(gca,fontsize=14)
% hold on
...
subplot(1,3,2)
plot(V,mode1_damp,'-ro',MarkerFaceColor='r',LineWidth=1.0,MarkerSize=8)
hold on
plot(V,mode2_damp,'-bs',MarkerFaceColor='b',LineWidth=1.0,MarkerSize=8)
hold on
plot(V,mode3_damp,'-kv',MarkerFaceColor='k',LineWidth=1.0,MarkerSize=8)
% hold on
% plot(V,mode4_damp,'-d','Color',[0.0 0.5 0.0],MarkerFaceColor=[0 0.5 0.0])
...
subplot(1,3,3)
plot(V,mode1_freq,'-ro',MarkerFaceColor='r',LineWidth=1.0,MarkerSize=8)
hold on
plot(V,mode2_freq,'-bs',MarkerFaceColor='b',LineWidth=1.0,MarkerSize=8)
hold on
plot(V,mode3_freq,'-kv',MarkerFaceColor='k',LineWidth=1.0,MarkerSize=8)
% hold on
% plot(V,mode4_freq,'-d','Color',[0.0 0.5 0.0],MarkerFaceColor=[0 0.5 0.0])
