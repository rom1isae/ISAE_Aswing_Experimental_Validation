...
dy = y(2)-y(1);
figure(1)
plot(y/y(end),13.5*L_cos,'-.r',linewidth=3)
ylim([-0.2 0.6])
% hold on
% plot(y,L_ellip,'--b')
xlabel('2y/b')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% JW_1_FW_30lb_90_10 + cantilever
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

extract_local_distribution_data('JW_1_30lb_90_10.txt');
load("JW_1_30lb_90_10.mat");
exp_data_fig_A3 = readtable("../Exp_data/Figure_A_3_Link_X_Z_rot.csv",NumHeaderLines=2);
...
figure(2)
plot(FW_y/FW_y(end),FW_Mx*lbft2Nm,'-r',LineWidth=1.5)
hold on
% plot(FW_y/FW_y(end),FW_Mc,'--r',LineWidth=1.5)
% hold on
plot(RW_y/FW_y(end),RW_Mx*lbft2Nm,'--b',LineWidth=1.5)
hold on
...
exp_y2 = exp_data_fig_A3.Var3;
exp_Mc2 = exp_data_fig_A3.Var4
plot(exp_y/exp_y(end),exp_Mc*lbft2Nm,'sr',MarkerFaceColor='r',MarkerSize=8)
hold on
plot(exp_y2/exp_y(end),exp_Mc2*lbft2Nm,'vb',MarkerFaceColor='b',MarkerSize=8)
hold on
...
hold on
plot(FW_y/FW_y(end),lbft2Nm*FW_Mx,'-.k',LineWidth=1.5)
hold on
xlabel('y/b')
ylabel('M_x in Nm')
grid on
...
hold on
exp_y = exp_data_fig_A3.Var1;
exp_Mx = exp_data_fig_A3.Var2;
plot(exp_y/exp_y(end),lbft2Nm*exp_Mx,'dk',MarkerFaceColor='k',MarkerSize=8)
title('30lbs (13,6kg), 90% FW and 10% RW')
legend('Joined wing: Forward: Aswing','Joined wing: Rear: Aswing','Joined wing: Forward: Exp','Joined wing: Rear: Exp','Cantilever wing : Aswing', 'Cantilever wing: Exp')
ylim([-5 45])
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ASWING Validation : JW_1_20lb_90_10%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

extract_local_distribution_data('JW_1_20lb_90_10.txt');
load("JW_1_20lb_90_10.mat");
exp_data_fig_A3 = readtable("../Exp_data/Figure_A_5_Link_X_Z_rot.csv",NumHeaderLines=2);
...
exp_y = exp_data_fig_A3.Var1;
exp_Mx = exp_data_fig_A3.Var2;
plot(exp_y/exp_y(end),(2/3)*lbft2Nm*exp_Mx,'dk',MarkerFaceColor='k',MarkerSize=8)
title('20lbs (9,1kg), 90% FW and 10% RW')
% legend('Joined wing: Forward: Aswing','Joined wing: Rear: Aswing','Joined wing: Forward: Exp','Joined wing: Rear: Exp','Cantilever wing : Aswing', 'Cantilever wing: Exp')
ylim([-5 45])


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ASWING Validation : JW_1_20lb_80_20% + cantilever wing
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

extract_local_distribution_data('JW_1_20lb_80_20.txt');
load("JW_1_20lb_80_20.mat");
exp_data_fig_A3 = readtable("../Exp_data/Figure_A_7_Link_X_Z_rot.csv",NumHeaderLines=2);
...
exp_Mx = exp_data_fig_A3.Var2;
plot(exp_y/exp_y(end),(2/3)*lbft2Nm*exp_Mx,'dk',MarkerFaceColor='k',MarkerSize=8)
title('20lbs (9,1kg), 80% FW and 20% RW')
% legend('Joined wing: Forward: Aswing','Joined wing: Rear: Aswing','Joined wing: Forward: Exp','Joined wing: Rear: Exp','Cantilever wing : Aswing', 'Cantilever wing: Exp')
ylim([-5 45])
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
