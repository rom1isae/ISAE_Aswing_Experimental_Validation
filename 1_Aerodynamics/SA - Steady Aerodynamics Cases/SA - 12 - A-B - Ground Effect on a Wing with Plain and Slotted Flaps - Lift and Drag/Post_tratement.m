...
% system('sh Aswing_Simulations/Rectangular_Wing_No_Flap_hc_inf.sh')
% system('sh Aswing_Simulations/Rectangular_Wing_No_Flap_hc_2.sh')
% system('sh Aswing_Simulations/Rectangular_Wing_No_Flap_hc_05.sh')
% 
% system('sh Aswing_Simulations/Rectangular_Wing_Flap_hc_inf.sh')
% system('sh Aswing_Simulations/Rectangular_Wing_Flap_hc_2.sh')
% system('sh Aswing_Simulations/Rectangular_Wing_Flap_hc_05.sh')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Rectangular wing with no flaps 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
No_flap_rect_CL = readtable('Experimental_Data/No_flap_Rect_CL.csv',NumHeaderLines=2);
No_flap_rect_CD = readtable('Experimental_Data/No_flap_Rect_CD.csv',NumHeaderLines=2);

rect_ASWING_h_c_05 = readtable('Aswing_Simulations/Rectangular_Wing_No_Flap_hc_05.txt',...
                                                         NumHeaderLines=3);
...
rect_ASWING_h_c_2 = readtable('Aswing_Simulations/Rectangular_Wing_No_Flap_hc_2.txt',...
                                                         NumHeaderLines=3);
...
rect_ASWING_h_c_inf = readtable('Aswing_Simulations/Rectangular_Wing_No_Flap_hc_inf.txt',...
                                                         NumHeaderLines=3);
...
flap_rect_CL = readtable('Experimental_Data/Flap_Rect_CL.csv',NumHeaderLines=2);
flap_rect_CD = readtable('Experimental_Data/Flap_Rect_CD.csv',NumHeaderLines=2);
rect_ASWING_h_c_05 = readtable('Aswing_Simulations/Rectangular_Wing_Flap_hc_05.txt',...
                                                         NumHeaderLines=3);
rect_ASWING_h_c_05_alpha = rect_ASWING_h_c_05.Var5;
rect_ASWING_h_c_05_CL = rect_ASWING_h_c_05.Var6;
rect_ASWING_h_c_05_CD = rect_ASWING_h_c_05.Var7;
...
rect_ASWING_h_c_2 = readtable('Aswing_Simulations/Rectangular_Wing_Flap_hc_2.txt',...
                                                         NumHeaderLines=3);
rect_ASWING_h_c_2_alpha = rect_ASWING_h_c_2.Var5;
rect_ASWING_h_c_2_CL = rect_ASWING_h_c_2.Var6;
rect_ASWING_h_c_2_CD = rect_ASWING_h_c_2.Var7;
...
rect_ASWING_h_c_inf = readtable('Aswing_Simulations/Rectangular_Wing_Flap_hc_inf.txt',...
                                                         NumHeaderLines=3);
rect_ASWING_h_c_inf_alpha = rect_ASWING_h_c_inf.Var5;
rect_ASWING_h_c_inf_CL = rect_ASWING_h_c_inf.Var6;
rect_ASWING_h_c_inf_CD = rect_ASWING_h_c_inf.Var7;
...
Data_temp = readtable('Airfoil_Xfoil_Analysis/xf-naca23012-il-1000000-n5',NumHeaderLines=12);
