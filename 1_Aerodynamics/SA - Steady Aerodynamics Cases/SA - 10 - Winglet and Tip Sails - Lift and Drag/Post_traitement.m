...
%% run simulations
% system('Aswing_Simulations/wing_alone.sh')
% system('Aswing_Simulations/wing_extension.sh')
% system('Aswing_Simulations/Louvered.sh')
% % system('Aswing_Simulations/TS_60_45_30.sh')
% % system('Aswing_Simulations/TS_80_60_40.sh')
% % system('Aswing_Simulations/TS_60_40_80.sh')

%% read data
wing_alone = readtable("Aswing_Simulations/wing_alone.txt",NumHeaderLines=3)
wing_extension = readtable("Aswing_Simulations/wing_extension.txt",NumHeaderLines=3);
Louvered = readtable("Aswing_Simulations/Louvered.txt",NumHeaderLines=3);
TS_60_45_30 = readtable("Aswing_Simulations/TS_60_45_30.txt",NumHeaderLines=3);
TS_80_60_40 = readtable("Aswing_Simulations/TS_80_60_40.txt",NumHeaderLines=3);
TS_60_40_80 = readtable("Aswing_Simulations/TS_60_40_80.txt",NumHeaderLines=3);


CD_CL_exp = readtable('Experimental_Data/CD_CL.csv',NumHeaderLines=2);
CL_VS_ALPHA = readtable('Experimental_Data/CL_VS_ALPHA.csv',NumHeaderLines=2);
TS_60_45_30_exp = readtable('Experimental_Data/CD_CL_tip_sail.csv',NumHeaderLines=2);
