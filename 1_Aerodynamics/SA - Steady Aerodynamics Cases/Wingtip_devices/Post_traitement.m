...
system('sh wing_alone_polar_Ma_0_70.sh')
system('sh wing_alone_polar_Ma_0_80.sh')


system('sh wing_extentsion_polar_Ma_0_70.sh')
system('sh wing_extentsion_polar_Ma_0_80.sh')

system('sh wingtip_up_polar_Ma_0_70.sh')
system('sh wingtip_up_polar_Ma_0_80.sh')


system('sh wingtip_up_and_down_polar_Ma_0_70.sh')
system('sh wingtip_up_and_down_polar_Ma_0_80.sh')
%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
WA_MA_0_70 = readtable('wing_alone/wing_alone_Ma_0_70.txt',NumHeaderLines=3);
WTU_MA_0_70 = readtable('Wing_tip_up/wingtip_up_Ma_0_70.txt',NumHeaderLines=3);
WTE_MA_0_70 = readtable('wing_extension/wing_extension_Ma_0_70.txt',NumHeaderLines=3);
WTUD_MA_0_70 = readtable('Wing_tip_up_and_down/wingtip_up_and_down_Ma_0_70.txt',NumHeaderLines=3);

WA_MA_0_80 = readtable('wing_alone/wing_alone_Ma_0_80.txt',NumHeaderLines=3);
WTU_MA_0_80 = readtable('Wing_tip_up/wingtip_up_Ma_0_80.txt',NumHeaderLines=3);
WTE_MA_0_80 = readtable('wing_extension/wing_extension_Ma_0_80.txt',NumHeaderLines=3);
WTUD_MA_0_80 = readtable('Wing_tip_up_and_down/wingtip_up_and_down_Ma_0_80.txt',NumHeaderLines=3);

MA_070_Exp = readtable('KC135_MA070.csv',NumHeaderLines=2);
MA_080_Exp = readtable('KC135_MA080.csv',NumHeaderLines=2);
...
CL_Alpha_MA07 = readtable('Ma07_CL_alpha.csv',NumHeaderLines=3);
CL_Alpha_MA08 = readtable('Ma08_CL_alpha.csv',NumHeaderLines=3);
